...
public class ObjectDetector
{
    ...
    public static int CAMERA_WATCH_TIME = 4;
    ...
    public void startCamera()
    {
        ...
        for (long stop = System.nanoTime() + TimeUnit.SECONDS.toNanos(CAMERA_WATCH_TIME); stop > System.nanoTime();)
        {
    ...
    class DetectionPipeline extends OpenCvPipeline
    {
        ...
        public Mat processFrame(Mat input)
        {
            ...
            Imgproc.line(output, new Point(0, approxHeight), new Point(320, approxHeight), new Scalar(0, 0, 255));
