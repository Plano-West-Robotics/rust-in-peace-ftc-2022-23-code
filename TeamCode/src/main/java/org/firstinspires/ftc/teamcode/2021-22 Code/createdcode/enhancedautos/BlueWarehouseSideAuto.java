...
public class BlueWarehouseSideAuto extends EnhancedAutoMode {
    ...
    public static int SHIPPING_ELEMENT_POS_2_X = 170;
    public static int SHIPPING_ELEMENT_POS_3_X = 290;
    ...
    public static double[] xCoordArrCase1 = {START_POS_X, -12, -12, -12, BLUE_WAREHOUSE_X};
    private static double[] yCoordArrCase1 = {START_POS_Y, 64, BLOCK_DROP_Y, 68, BLUE_WAREHOUSE_Y};
    private static double[] angleArrCase1 = {START_POS_ANGLE, -90, -90, 0, BLUE_WAREHOUSE_ANGLE};
    private static int[] methodIdArrCase1 = {START_METHOD, 13, 22, 10, 0};

    public static double[] xCoordArrCase2 = {START_POS_X, -12, -12, -12, BLUE_WAREHOUSE_X};
    private static double[] yCoordArrCase2 = {START_POS_Y, 64, BLOCK_DROP_Y, 68, BLUE_WAREHOUSE_Y};
    private static double[] angleArrCase2 = {START_POS_ANGLE, -90, -90, 0, BLUE_WAREHOUSE_ANGLE};
    private static int[] methodIdArrCase2 = {START_METHOD, 12, 22, 10, 0};

    public static double[] xCoordArrCase3 = {START_POS_X, -12, -12, -12, BLUE_WAREHOUSE_X};
    private static double[] yCoordArrCase3 = {START_POS_Y, 64, BLOCK_DROP_Y, 68, BLUE_WAREHOUSE_Y};
    private static double[] angleArrCase3 = {START_POS_ANGLE, -90, -90, 0, BLUE_WAREHOUSE_ANGLE};
