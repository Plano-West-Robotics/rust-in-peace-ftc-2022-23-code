...
public class ChassisDrive extends OpMode {
    ...
    public void init(){
        frontRight = hardwareMap.get(DcMotor.class, frontRightMotorName) ;
        frontLeft = hardwareMap.get(DcMotor.class, frontLeftMotorName);
        rearRight = hardwareMap.get(DcMotor.class, backRightMotorName);
        rearLeft = hardwareMap.get(DcMotor.class, backLeftMotorName);
