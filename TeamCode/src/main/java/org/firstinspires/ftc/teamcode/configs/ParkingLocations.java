...
public class ParkingLocations {
    public static Pose2d F2Point1 = new Pose2d(-60, -12, Math.toRadians(-90));
    //public static Pose2d F2Point2 = new Pose2d(-45, -27);

    public static Pose2d F5Point1 = new Pose2d(11, -12, Math.toRadians(90));
    //public static Pose2d F5Point2 = new Pose2d(9, -27);

    public static Pose2d A2Point1 = new Pose2d(-59, 12, Math.toRadians(-90));
    //public static Pose2d A2Point2 = new Pose2d(-45, 27);

    public static Pose2d A5Point1 = new Pose2d(11, 12, Math.toRadians(90));
