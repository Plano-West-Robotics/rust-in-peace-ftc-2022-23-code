...
@Autonomous
public class Instructable_A2_Right_Dev extends InstructableBase{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory traj1 = driver.trajectoryBuilder(startPose)
                .splineToConstantHeading(new Vector2d(-24, 60), Math.toRadians(0), VEL_CONSTRAINT, ACCEL_CONSTRAINT)
