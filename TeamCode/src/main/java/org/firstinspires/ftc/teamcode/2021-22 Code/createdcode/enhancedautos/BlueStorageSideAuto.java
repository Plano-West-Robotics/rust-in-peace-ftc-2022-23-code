...
@Config
public class BlueStorageSideAuto extends EnhancedAutoMode {
    ...
    public static double[] xCoordArrCase0 = {START_POS_X, -56, -56, BLOCK_DROP_POINT, -56, BLUE_CAROUSEL_X, BLUE_STORAGE_X};
    private static double[] yCoordArrCase0 = {START_POS_Y, 48, 24, 24, 24, BLUE_CAROUSEL_Y, BLUE_STORAGE_Y};
    private static double[] angleArrCase0 = {START_POS_ANGLE, 180, 90, 0, 0, BLUE_CAROUSEL_ANGLE, BLUE_STORAGE_ANGLE};
    private static int[] methodIdArrCase0 = {START_METHOD, 11, 0, 22, 10, 32, 0};
    ...
    public void runOpMode(){
        ...
        telemetry.addData("Position Detected is", pos);
